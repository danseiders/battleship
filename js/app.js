...
//this section randomly places the computers ships and makes them disappear with opacity. the arrays below are pixel values
...
const startGame = () => {
  ...
  $('.start_button').remove()
  $('.player1_board_squares').css('background-color', 'cadetblue').css('border-radius', '0')
